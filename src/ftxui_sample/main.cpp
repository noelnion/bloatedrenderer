...
// configuration step. It creates a namespace called `bloatedrenderer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", bloatedrenderer::cmake::project_name, bloatedrenderer::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", bloatedrenderer::cmake::project_version);
      return EXIT_SUCCESS;
    }
